  ...
  return (
    <div className="absolute z-10 bg-black bg-opacity-70 px-6">
      <div className="mx-auto w-full max-w-[540px] rounded-lg bg-white p-8">
        ...
        <div className="min-[500px]:flex-row mt-8 flex flex-col">
          <div className="min-[500px]:rounded-l-lg min-[500px]:rounded-r-none min-[500px]:text-sm flex grow flex-col gap-4 rounded-t-lg bg-gray px-4 py-6 text-xs">
          ...
          <div className="min-[500px]:rounded-l-none min-[500px]:rounded-r-lg flex flex-col justify-center gap-2 rounded-b-lg bg-almostBlack px-4 pt-4 pb-5 text-white">
            <p className="uppercase opacity-50">grand total</p>
            <p className="text-lg">$ 5, 446</p>
          </div>
        </div>
        <Button className="mt-12">Back to Home</Button>
      </div>
    </div>
  );
}
