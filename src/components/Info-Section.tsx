...
export default function InfoSection() {
  return (
    <section className="flex min-[1150px]:px-0 mx-auto mt-6 mb-[7.5rem] w-full max-w-[1110px] flex-col items-center gap-8 px-6 md:mb-24 md:gap-16 md:px-10 lg:mb-36 lg:flex-row lg:gap-[30px]">
      <div className="flex mx-auto w-full grow basis-1/2 flex-col items-center gap-8 lg:max-w-[445px]">
      ...
      <picture className="flex min-[1110px]:basis-1/2 order-first justify-end lg:order-last lg:ml-auto">
        <source
